...
public class LevelCompletionGate : BaseLevelObject
{
    // ----------------------
    //
    // This object is used to properly end the level, save the player's progress, and load the next level
    //
    // ----------------------
    ...
    private void LoadNewScene()
    {
        if (level.LevelData.NextLevel != null)
        {
            ...
            SceneManager.LoadScene(level.LevelData.NextLevel.LevelSceneID);
        }
    }
}
